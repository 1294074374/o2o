$(function() {
	...
	// 获取商铺商品列表的一二级目录以及区域列表的URL
	var searchDivUrl = 'listshopspageinfo';
	// 页码
	var pageNum = 1;
	// 从地址栏UTL里尝试获取parent shop category id
	...
	$('#shoplist-search-div').on(
			...
			function(e) {
				if (parentId) {// 如果传递过来的是一个父类下的子类
					...
					// 若之前已选定了别的category，则移除其选定效果，改成新的
	...
	// 需要查询的店铺名字发生变化后，重置页码，清空原先的店铺，重置区域列表
